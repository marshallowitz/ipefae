...
namespace TGV.IPEFAE.Web.App.Models.Bradesco.Request
{
    public class BoletoRegistroRequest
    {
        ...
        public bool aplicar_multa { get; set; } = false;
        public string valor_percentual_multa { get; set; }
        public string valor_desconto_bonificacao { get; set; }
        public bool debito_automatico { get; set; } = false;
        public bool rateio_credito { get; set; } = false;
