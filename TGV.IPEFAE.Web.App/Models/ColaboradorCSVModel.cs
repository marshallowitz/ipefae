...
namespace TGV.IPEFAE.Web.App.Models
{
    ...
    {
        public ColaboradorCSVModel(ColaboradorModel colaborador, List<tb_est_estado> Estados, List<tb_cid_cidade> Cidades, List<GrauInstrucaoModel> grausInstrucao, List<RacaModel> racas, List<BancoModel> bancos)
        {
            if (colaborador == null)
                return;
