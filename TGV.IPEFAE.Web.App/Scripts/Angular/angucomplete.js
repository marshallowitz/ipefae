...
}(window, function (angular)
{
    ...
    angular.module('angucomplete-alt', []).directive('angucompleteAlt', ['$q', '$filter', '$parse', '$http', '$sce', '$timeout', '$templateCache', '$interpolate', function ($q, $filter, $parse, $http, $sce, $timeout, $templateCache, $interpolate)
    {
        // keyboard events
        var KEY_DW = 40;
        var KEY_RT = 39;
                ...
                if (scope.localData) {
                    scope.$apply(function ()
                    {
                        ...
                        if (typeof scope.localSearch() !== 'undefined') {
                            matches = scope.localSearch()(str, scope.localData, scope.localColaboradorId);
                        } else {
